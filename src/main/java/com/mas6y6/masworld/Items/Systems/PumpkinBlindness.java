...
public class PumpkinBlindness {
    ...
    public PumpkinBlindness() {
        Bukkit.getScheduler().runTaskTimer(Masworld.instance(), this::tick, CHECK_PERIOD_TICKS, CHECK_PERIOD_TICKS);
    }
    ...
    private void tick() {
        ...
        for (Player viewer : Bukkit.getOnlinePlayers()) {
            ...
            for (Player wearer : wearers) {
                ...
                @NotNull Vector toWearer = wearer.getEyeLocation().toVector()
