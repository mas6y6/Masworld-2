...
public class WeaponListeners implements Listener {
    ...
    public void dynamiteThrow(ProjectileLaunchEvent event) {
        ...
        if (projectile.getShooter() instanceof Player player) {
            ...
            if (item.hasItemMeta()) {
                ...
                NamespacedKey specialEffectId = new NamespacedKey(Masworld.instance(), "special_effect");
                NamespacedKey powerkey = new NamespacedKey(Masworld.instance(), "dynamite_power");
                NamespacedKey fusekey = new NamespacedKey(Masworld.instance(), "dynamite_fuse");
    ...
    public void dynamiteHit(ProjectileHitEvent event) {
        ...
        if (projectile.getPersistentDataContainer().has(specialEffectId, PersistentDataType.STRING)) {
            ...
            if ("dynamite".equals(effect)) {
                ...
                final int taskId = Bukkit.getScheduler().scheduleSyncRepeatingTask(Masworld.instance(), () -> {
                ...
                Bukkit.getScheduler().runTaskLater(Masworld.instance(), () -> {
                    if (!snowball.isDead()) {
                        snowball.remove();
                    }
    ...
    public void shulkerSword(PlayerInteractEvent event) {
        NamespacedKey special_effectKey = new NamespacedKey(Masworld.instance(), "special_effect");
        NamespacedKey cooldownKey = new NamespacedKey(Masworld.instance(), "shulker_sword_cooldown");
        NamespacedKey bulletsKey = new NamespacedKey(Masworld.instance(), "shulker_sword_bullet");
        NamespacedKey rangeKey = new NamespacedKey(Masworld.instance(), "shulker_sword_range");
    ...
    public void evokerBook(PlayerInteractEvent event) {
        NamespacedKey special_effectKey = new NamespacedKey(Masworld.instance(), "special_effect"); // STR
        NamespacedKey evoker_book_range = new NamespacedKey(Masworld.instance(), "evoker_book_range"); // INT
        NamespacedKey evoker_book_angle = new NamespacedKey(Masworld.instance(), "evoker_book_angle"); // INT
        NamespacedKey evoker_book_beamcount = new NamespacedKey(Masworld.instance(), "evoker_book_beamcount"); // INT
        NamespacedKey evoker_book_spacing = new NamespacedKey(Masworld.instance(), "evoker_book_spacing"); // DOUBLE
        NamespacedKey evoker_book_cooldown = new NamespacedKey(Masworld.instance(), "evoker_book_cooldown"); // LONG
        ...
        Masworld plugin = Masworld.instance();
    ...
    public void dragonSythe(PlayerInteractEvent event) {
        NamespacedKey specialEffectKey = new NamespacedKey(Masworld.instance(), "special_effect");
    ...
    public void gravityStriker(PlayerInteractEvent event) {
        ...
        }.runTaskTimer(Masworld.instance(), 0L, 1L);
    ...
    private boolean isVoidBundle(ItemStack item) {
        ...
        NamespacedKey key = new NamespacedKey(Masworld.instance(), "special_effect");
    ...
    public void onEntityCapture(PlayerInteractEntityEvent event) {
        ...
        NamespacedKey storedKey = new NamespacedKey(Masworld.instance(), "void_bundle_entity");
    ...
    public void crossbowDynamite(PlayerLaunchProjectileEvent event) {
        ...
        NamespacedKey special_effect = new NamespacedKey(Masworld.instance(), "special_effect");
        NamespacedKey fusekey = new NamespacedKey(Masworld.instance(), "dynamite_fuse");
        NamespacedKey powerkey = new NamespacedKey(Masworld.instance(), "dynamite_power");
